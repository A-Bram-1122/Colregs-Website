...
const examScenarios = [
    // Fleet ROR Apr 14 - Faslane to Portsmouth
    {
        ...
        questions: [
            ...
            { originalNumber: 4, text: "You take back the conning and clear the yacht race. Contrary to the Navigating Officer's brief you sight a thick fog bank approximately 1 nautical mile away. In this situation, within the flog you hear one prolonged blast ahead of the ship but are unsure as to the exact direction it came from. What action shall you take?", ruleRef: "R19e" },
    ...
    // Fleet ROR Feb 15 - T23 Solent to Needles
    {
        ...
        scenario: "You are the Officer of the Watch of a T23 frigate (length 133 metres), having just passed Outer Spit Buoy and entered the Solent to make a transit to the Needles Channel. It is the forenoon watch, the weather is fine with good visibility, however a cold front is forecast. Shipping is moderate.",
        questions: [
    ...
    // FOST ROR Oct 16 - HMS KENT
    {
        ...
        scenario: "You are the Officer of the Watch of HMS KENT (T23 frigate, length 133 metres). The ship has just sailed from Portsmouth. It is the forenoon watch, the weather is fine with good visibility. The shipping is moderate.",
        questions: [
